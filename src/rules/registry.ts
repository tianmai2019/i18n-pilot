...
import type { Rule, RuleConfig, Severity } from '../types/index.js';
...
export class RuleRegistry {
  ...
  resolve(config: RuleConfig = {}): ResolvedRule[] {
   ...
   */
  static async autoDiscover(registry?: RuleRegistry): Promise<RuleRegistry> {
